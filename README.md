...
[![Gmail](https://img.shields.io/badge/Gmail-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:faid.saadd@gmail.com)
[![Phone](https://img.shields.io/badge/Call_Me-25D366?style=for-the-badge&logo=whatsapp&logoColor=white)](tel:+212634667536)
...
**🚗 VemoCar - Rental Agency**
Full-stack car rental agency: vehicle browsing, bookings, coupons, and admin panel.
`React` `Node.js` `PostgreSQL`

[![Repo](https://img.shields.io/badge/Repository-21262D?style=for-the-badge&logo=github)](https://github.com/SaadFaid/VemoCar_RentalAgency)

</td>
<td>

**💰 Finza - AI Finance Tracker**
Personal finance tracker with transactions, budgets, and AI-powered spending insights.
`React` `TypeScript` `Supabase`

[![Repo](https://img.shields.io/badge/Repository-21262D?style=for-the-badge&logo=github)](https://github.com/SaadFaid/Finza-AI-Finance-Tracker)
...
**🛍️ TchizuShop - eCommerce**
Modular eCommerce platform: product catalog, cart, checkout, and admin dashboard.
`TypeScript` `Express` `PostgreSQL`

[![Repo](https://img.shields.io/badge/Repository-21262D?style=for-the-badge&logo=github)](https://github.com/SaadFaid/tchizushop)

</td>
<td>

**👗 Clothing Store**
Full-featured online storefront with admin dashboard.
`React` `TypeScript` `Vite` `Stripe`

[![Repo](https://img.shields.io/badge/Repository-21262D?style=for-the-badge&logo=github)](https://github.com/SaadFaid/clothing-store-)
...
**🎯 Goals Tracker**
Monthly goals tracker with weighted actions, rewards, and snapshots.
`React` `Node.js` `PostgreSQL`

[![Repo](https://img.shields.io/badge/Repository-21262D?style=for-the-badge&logo=github)](https://github.com/SaadFaid/goals-tracker)

</td>
<td>

**🚗 Bghit Nsog - Landing Page**
Single-page landing site for a car rental business.
`HTML` `CSS` `JavaScript`

[![Repo](https://img.shields.io/badge/Repository-21262D?style=for-the-badge&logo=github)](https://github.com/SaadFaid/bghit_nsog_landing_page)
...
**🏢 YourAgency Digital**
Premium portfolio website for a digital agency.
`React` `TypeScript` `Framer Motion`

[![Repo](https://img.shields.io/badge/Repository-21262D?style=for-the-badge&logo=github)](https://github.com/SaadFaid/Novavision-Digital)

</td>
<td>

**🎮 Loading Screen**
Custom FiveM server loading screen with branded HTML/CSS/JS art.
`JavaScript` `Lua` `HTML/CSS`

[![Repo](https://img.shields.io/badge/Repository-21262D?style=for-the-badge&logo=github)](https://github.com/SaadFaid/loading-page)
